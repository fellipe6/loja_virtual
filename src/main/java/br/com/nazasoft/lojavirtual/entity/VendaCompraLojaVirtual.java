...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@OneToOne
	@JoinColumn(name = "nota_fiscal_venda", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "nota_fiscal_venda_fk"))
	private NotaFiscalVenda fiscalVenda;

	@ManyToOne
	@JoinColumn(name = "cupom_desc", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "cupom_desc_fk"))
