...
COPY public.conta_pagar (id, desconto, descricao, dt_pagamento, dt_vencimento, status, valor_total, pessoa_id, pessoa_forn_id) FROM stdin;
\.
...
COPY public.conta_receber (id, desconto, descricao, dt_pagamento, dt_vencimento, status, valor_total, pessoa_id) FROM stdin;
\.
...
COPY public.cup_desc (id, cod_desc, data_validade, valor_porcent_desc, valor_real_desc) FROM stdin;
\.
...
COPY public.vd_cp_loja_virt (id, data_entrega, data_venda, dia_entrega, valor_desconto, valor_fret, valor_total, cupom_desc_id, endereco_cobranca_id, endereco_entrega_id, forma_pagamento_id, nota_fiscal_venda_id, pessoa_id) FROM stdin;
\.
